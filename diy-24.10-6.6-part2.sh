...
# sed -i "s/DISTRIB_RELEASE='R[0-9]*\.[0-9]*\.[0-9]*/DISTRIB_REVISION='$modelmark/g" ./package/emortal/default-settings/files/99-default-settings
...
# Add 360 T7 108M
wget -O "target/linux/mediatek/dts/mt7981b-qihoo-360t7-108M.dts" "https://github.com/zonghewang/Action-237-immortalwrt-mt798x-24.10/raw/refs/tags/2025.12.21-2013/target/linux/mediatek/dts/mt7981b-qihoo-360t7-108M.dts"
wget -O "target/linux/mediatek/image/filogic.mk" "https://github.com/zonghewang/Action-237-immortalwrt-mt798x-24.10/raw/refs/tags/2025.12.21-2013/target/linux/mediatek/image/filogic.mk"
